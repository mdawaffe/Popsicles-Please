...
function get_city_from_google_maps( lat, lng ) {
	...
	return new Promise( function( resolve, reject ) {
		...
		_this.geocode.reverse( lat, lng, { result_type: 'locality|administrative_area_level_3|administrative_area_level_2' }, function( err, data ) {
			if ( err ) {
				...
				console.log( "< GOOGLE:", lat, lng, data.results[0].formatted_address );
				resolve( {
